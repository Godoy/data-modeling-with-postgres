...
songplay_table_create = ("""
                        ...
                        user_id INT NOT NULL, level TEXT, song_id TEXT,
...
user_table_create = ("""
                    CREATE TABLE users
                    (user_id INT PRIMARY KEY, first_name TEXT, gender CHAR,
                    last_name TEXT, level TEXT)
                    """)

song_table_create = ("""
                    CREATE TABLE songs (song_id TEXT PRIMARY KEY, title TEXT,
                    duration DECIMAL, year INT, artist_id TEXT NOT NULL);
                    """)

artist_table_create = ("""
                      CREATE TABLE artists (artist_id TEXT PRIMARY KEY,
                      name TEXT, latitude FLOAT, longitude FLOAT,
                      location TEXT);
                      """)
...
user_table_insert = ("""
                    INSERT INTO users
                    (user_id, first_name, gender, last_name, level)
                    VALUES (%s, %s, %s, %s, %s)
